...
SRC_URI="${SRC_URI}
http://dotmac.googlecode.com/svn/trunk/Patches/Apache/ampquotefix.patch
http://dotmac.googlecode.com/svn/trunk/Patches/Apache/quota.patch.txt"
...
src_unpack() {
	...
	apache-2_src_unpack
	epatch ${DISTDIR}/ampquotefix.patch
	epatch ${DISTDIR}/quota.patch.txt
}

pkg_postinst() {
	apache-2_pkg_postinst

	# create logs directory for dotmac
	mkdir "${ROOT}"etc/apache2/logs >/dev/null 2>&1
