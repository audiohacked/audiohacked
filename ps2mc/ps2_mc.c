...
int mc2rw_card_auth(usb_dev_handle *udev)
{
	...
	unsigned char auth6[] = {
		0xaa, 0x42, 0x0D, 0x00, 0x81, 0xF0, 0x06, 0x00,
		0x00, 0x0E, 0xa3, 0xb3, 0xa0, 0x31, 0x19, 0x5b,
		0x9c, 0x3f, 0x60, 0x00, 0x00};
	unsigned char auth7[] = {
		0xaa, 0x42, 0x0D, 0x00, 0x81, 0xF0, 0x07, 0x00,
		0x00, 0x0E, 0xa9, 0xc7, 0x01, 0xeb, 0x9b, 0x34,
		0xda, 0x69, 0x98, 0x00, 0x00};
	unsigned char auth11[] = {
		0xaa, 0x42, 0x0D, 0x00, 0x81, 0xF0, 0x0B, 0x0E,
		0xc8, 0xe0, 0x72, 0xce, 0x96, 0x31, 0xdc, 0x21,
		0xce, 0x00, 0x00};
...
int mc2rw_reset_auth(usb_dev_handle *udev)
{
	...
	unsigned char temp[256],
		cmd[148]={0xaa, 0x42, 0x05, 0x00, 0x81, 0xF3, 0x00, 0x00, 0x00},
		cmd_f7[] = {0xaa, 0x42, 0x05, 0x00, 0x81, 0xF7, 0x01, 0x00, 0x00};
